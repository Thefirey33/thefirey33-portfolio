...
export const TimeZoneDisplay = () => {
    const [currentTime, setCurrentTime] = useState("kalkulating!!!");
    ...
    return (
        <div className={`grid grid-cols-${offline ? '2' : '1'} gap-4 w-full justify-center items-center`}>
            <p className="text-white text-center md:text-xl font-extrabold select-none">Time for me: {currentTime}</p>
